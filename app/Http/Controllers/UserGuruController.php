...
class UserGuruController extends Controller
{
    ...
    {
        $userg = User::where('role', 'guru')->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('userg.home')->with('success', 'Berhasil menambahkan Pengguna!');

        } catch (\Throwable $th) {
            //throw $th;
            return redirect()->route('userg.home')->with('danger', 'Gagal menambahkan data pengguna!');
    ...
    public function edit(string $id)
    {
        ...
        return view('userg.edit', compact('users'));
    }
